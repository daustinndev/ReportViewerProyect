...
/****** Object:  Database [VENTA]    Script Date: 12/16/2022 9:22:06 AM ******/
CREATE DATABASE [VENTA]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'sale', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\sale.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'sale_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\sale_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [VENTA] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [VENTA] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [VENTA] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [VENTA] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [VENTA] SET QUERY_STORE = OFF
GO
